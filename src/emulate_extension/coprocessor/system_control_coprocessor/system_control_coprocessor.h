...
enum CoprocessorRegisterType {
    ...
    REGISTER_TYPE_C2_TRANSLATION_TABLE_BASE_REGISTER0,
    REGISTER_TYPE_C2_TRANSLATION_TABLE_BASE_REGISTER1,
    REGISTER_TYPE_C2_TRANSLATION_TABLE_BASE_CONTROL_REGISTER
};
