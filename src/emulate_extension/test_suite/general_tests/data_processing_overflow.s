...
addc r5, r3, r7 // no overflow
addc r11, r6, r3 // no overflow
...
subc r7, r7, r3 // no borrow
subc r6, r8, r5 // no borrow
...
addc r4, r1, r5 ;overflow
addc r5, r1, r6 ;overflow
mov r0, #0
mov r1, #0xffffffff
mov r2, #2
mov r3, #3
...
mul r4, r4, r6 ; no overflow
mula r0, r2, r3, r1 ; overflow
mula r0, r10, r2, r9 ; no overflow
mov r0, #0
mov r1, #0xffffffff
mov r2, #2
mov r3, #2
