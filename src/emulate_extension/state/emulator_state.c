...
void set_word_in_system_control_coprocessor(enum CoprocessorRegisterType type, Word val) {
    switch (type) {
        case REGISTER_TYPE_C1_CONTROL:

        case REGISTER_TYPE_C1_AUXILIARY_CONTROL:

        case REGISTER_TYPE_C1_SECURE_CONFIGURATION:

        case REGISTER_TYPE_C1_SECURE_DEBUG_ENABLE:

        case REGISTER_TYPE_C1_NONE_SECURE_ACCESS_CONTROL:
        case REGISTER_TYPE_C1_COPROCESSOR_ACCESS_CONTROL:
        case REGISTER_TYPE_C12_SECURE_OR_NON_SECURE_VECTOR_BASE_ADDRESS:
        case REGISTER_TYPE_C0_MAIN_ID:
        case REGISTER_TYPE_C0_CPUID:
        case REGISTER_TYPE_C2_TRANSLATION_TABLE_BASE_REGISTER0:
        case REGISTER_TYPE_C2_TRANSLATION_TABLE_BASE_REGISTER1:
        case REGISTER_TYPE_C2_TRANSLATION_TABLE_BASE_CONTROL_REGISTER:
    }

}

Word get_word_from_system_control_coprocessor_register(enum CoprocessorRegisterType type) {
    struct SystemControlCoprocessor c15 = state.systemControlCoprocessor;
    switch (type) {
        case REGISTER_TYPE_C1_CONTROL:
            return *((Word *) &c15.c1_control_register);
        case REGISTER_TYPE_C1_AUXILIARY_CONTROL:
            return *((Word *) &c15.c1_auxiliary_control_register);
        case REGISTER_TYPE_C1_SECURE_CONFIGURATION:
            return *((Word *) &c15.c1_secure_configuration_register);
        case REGISTER_TYPE_C1_SECURE_DEBUG_ENABLE:
            return *((Word *) &c15.c1_secure_debug_enable_register);
        case REGISTER_TYPE_C1_NONE_SECURE_ACCESS_CONTROL:
            return *((Word *) &c15.c1_none_secure_access_control_register);
        case REGISTER_TYPE_C1_COPROCESSOR_ACCESS_CONTROL:
            return *((Word *) &c15.c1_coprocessor_access_control_register);
        case REGISTER_TYPE_C12_SECURE_OR_NON_SECURE_VECTOR_BASE_ADDRESS:
            return *((Word *) &c15.c12_secure_or_non_secure_vector_base_address_register);
        case REGISTER_TYPE_C0_MAIN_ID:
            return *((Word *) &c15.c0_main_id_register);
        case REGISTER_TYPE_C0_CPUID:
            return *((Word *) &c15.c0_cpuid_register);
        case REGISTER_TYPE_C2_TRANSLATION_TABLE_BASE_REGISTER0:
            return *((Word *) &c15.c1_control_register);
        case REGISTER_TYPE_C2_TRANSLATION_TABLE_BASE_REGISTER1:
            return *((Word *) &c15.c1_control_register);
